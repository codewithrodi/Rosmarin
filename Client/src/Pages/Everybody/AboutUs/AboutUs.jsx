...
const AboutUsPage = () => {
    ...
    const PurposesData = [
        [<BsHeart />, 'Experiencias', 'Comprometidos en contribuir y/o mejorar la construcción de nuevas experiencias significativas, dentro de un entorno el cual sea inclusivo con la finalidad de que dejen huellas en cada uno de los estudiantes que alberga el establecimiento.'],
